...
# Create policy
$PolicyDefinition = New-AzPolicyDefinition -Name $PolicyName -Policy $PSScriptRoot/$PolicyFile -DisplayName $PolicyName -Description $PolicyName -Parameter $PSScriptRoot/$PolicyParamFile -Mode All
